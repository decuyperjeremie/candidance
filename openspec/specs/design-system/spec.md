...
Define a shared, light editorial visual language for every web surface of the application — design tokens as a single source of truth, a consistent off-white/serif-sans aesthetic, and consistent application across navigation, home, offer list, offer detail, and tracking views — as a presentation-only layer that does not change application behaviour or generated-document styling.
